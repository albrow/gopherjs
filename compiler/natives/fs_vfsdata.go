...
var FS = func() http.FileSystem {
	...
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: mustUnmarshalTextTime("2017-05-20T16:07:38Z"),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
